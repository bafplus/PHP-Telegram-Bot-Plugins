...
class TimeCommand extends UserCommand
{
     ...
     * @var string
     */
    private $date_format = 'd-m-Y h:i A';
    ...
    private function getFormattedDate($location)
    {
        ...
        $date_utc = new \DateTimeImmutable(gmdate('Y-m-d H:i', $local_time), new \DateTimeZone($timezone_id));

        return 'The local time in ' . $location . ' is: ' . $date_utc->format($this->date_format);
    }
    ...
    public function execute()
    {
        ...
        $text = 'You must specify location in format: /time <city>';
